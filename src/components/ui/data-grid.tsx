...
export interface DataGridProps<TData extends object> {
  ...
  tableLayout?: {
    ...
    showColumnsPinnable?: boolean; // custom by puninar dev

    showPaginationSection?: boolean; // custom by puninar dev
    
    showTotalRows?: boolean; // custom by puninar dev
    showRowPerPage?: boolean; // custom by puninar dev
    showPageOf?: boolean; // custom by puninar dev
    showPagination?: boolean; // custom by puninar dev
